...
.. exercise:: Einfache Lambda-Funktionen
    ...
    .. code:: java
        ...
        public static void main(String[] args) {
            List<String> names = Arrays.asList("Diana", "Alice", "Charlie", "Bob", "Eve");
            List<Integer> grades = Arrays.asList(85, 42, 91, 67, 55);

            // TODO 1: Using a lambda, sort the names
            names.sort(...);
...
.. exercise:: Erste Implementierung von Funktionen höherer Ordnung
    ...
    - :java:`void forEach(Consumer<...> action)`: Führt die Aktion für jedes Element in dem :java:`Tuple` aus.
    - :java:`void replaceAll(UnaryOperator<...> operator)`: Ersetzt alle Elemente im :java:`Tuple` durch das Ergebnis der Anwendung des Operators auf das Element.
    ...
    .. supplemental::
        ...
        - API Dokumentation: https://docs.oracle.com/en/java/javase/25/docs/api/allclasses-index.html
          ...
          (Hier der Link auf die Dokumentation der Klasse :java:`UnaryOperator`: https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/function/UnaryOperator.html)
...
- :java:`T dequeue()` oder :java:`T poll()`: Entfernt das älteste Element und gibt es zurück.
...
- Anstelle von :java:`null` als Rückgabewert sollte man :java:`Optional<T>` bevorzugen, um klar zu kommunizieren, dass es auch keinen Rückgabewert geben kann.
