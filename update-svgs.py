...
def update_svg_dimensions(svg_file_path, multiplier=3):
...
def find_svg_files(root_dir):
    ...
    pattern = os.path.join(root_dir, "ds-se-entwurfsprinzipien", "images", "**", "*.svg")
...
def main():
    ...
    for svg_file in svg_files:
        ...
        if update_svg_dimensions(svg_file, 3):
            updated_count += 1
